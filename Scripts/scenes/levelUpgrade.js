...
var scenes;
(function (scenes) {
    var LevelUpgrade = /** @class */ (function (_super) {
        __extends(LevelUpgrade, _super);
        // constructors
        ...
        // private methods
        // public methods
        LevelUpgrade.prototype.Start = function () {
        ...
        LevelUpgrade.prototype.Update = function () {
            this._ocean.Update();
        };
        LevelUpgrade.prototype.Reset = function () {
        };
        LevelUpgrade.prototype.Destroy = function () {
            this.removeAllChildren();
        };
        LevelUpgrade.prototype.Main = function () {
    ...
    scenes.LevelUpgrade = LevelUpgrade;
})(scenes || (scenes = {}));
